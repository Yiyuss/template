...
c2_library_noon: {
    ...
    dialogues: [
        ...
        { character: '旁白', text: '然而，夜語花的影像卻像藤蔓般纏繞在她腦海。', image: 'assets/images/letters/01.png' },
        { character: '旁白', text: '她開始懷疑，那朵花究竟只是幻覺，還是她心境外洩的具象？' , image: 'assets/images/letters/01.png'},
        { character: '旁白', text: '——' },
...
c3_dorm_morning: {
    ...
    dialogues: [
        ...
        { character: '旁白', text: '床邊放著她的日記本，深綠色的封面，邊角因頻繁翻閱而稍稍磨損。', image: 'assets/images/letters/book.png' },
        { character: '旁白', text: '她下意識伸手，將它抱在懷裡，指尖摩挲著紙頁的粗糙質感。', image: 'assets/images/letters/book.png' },
...
c4b_inner_letters: {
    ...
    dialogues: [
        { character: '【場景：內心世界】', text: '第一封信，紙張仍帶著未乾的墨香。', image: 'assets/images/letters/02.png' },
        { character: '信件一', text: '「親愛的自己，今天我又看見了她。」', image: 'assets/images/letters/02.png' },
        { character: '信件一', text: '「她站在校門口，陽光落在她的髮上，像在閃爍。」', image: 'assets/images/letters/02.png' },
...
c5a_lily: {
    ...
    dialogues: [
        ...
        { character: '旁白', text: '是一朵白色的瑪格麗特花，清晨時她們在廣場邊的花壇裡摘下來的。' },
...
c5b_library: {
    ...
    dialogues: [
        { character: '【場景：圖書館・地下室】', text: '那本封面最黑的冊子，赫然刻著金字——', image: 'assets/images/letters/22036745.png' },
        { character: '旁白', text: '《花名冊》。', image: 'assets/images/letters/22036745.png' },
...
c5b_garden: {
    ...
    dialogues: [
        ...
        { character: '旁白', text: '瑪格麗特坐在花園的長椅上，指尖摩挲著花朵的莖。' },
...
c6b_shadow_foreshadow: {
    ...
    dialogues: [
        ...
        { character: '旁白', text: '——' },
                { character: '旁白', text: '【第六章·完】' },
                { character: '旁白', text: '—— 請通關森森鈴蘭路線解鎖 ——', choices: [ { text: '前往第七章(未解鎖)', nextScene: 'start' }, { text: '隱藏路線(未解鎖)', nextScene: 'start' } ] }
            ]
        },
