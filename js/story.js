...
const Story = {
  ...
  scenes: {
    start: {
      ...
      dialogues: [
        ...
        { character: '伊鬱', text: '請選擇妳想成為的角色：', choices: [
    ...
    city: {
      ...
      dialogues: [
        ...
        { character: '路人', text: '是的，這裡總是很熱鬧。你想看看商店嗎？', choices: [
    ...
    forest: {
      ...
      dialogues: [
        ...
        { character: '嚮導', text: '你想去看看森林深處的湖泊嗎？', choices: [
  ...
  loadScene(sceneName) {
    ...
    } else if (this.defaultBgm) {
      AudioManager.playBgm(this.defaultBgm);
    }
  ...
  showDialogue() {
    ...
    if (charName) charName.textContent = dialogue.character || "";
